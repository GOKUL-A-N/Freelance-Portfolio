  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.body}>
        ...
        <h1 className='text-center text-[35px] sm:text-[35px] leading-tight md:text-[55px] xl:text-[65px]  md:tracking-wide  uppercase font-black'>Crafting <br /> <span className='text-[#0de1d4]'>digital</span> <br /> <span className='text-[#0de1d4]'>experience</span> <br /> that <br /> ignite <br /> your <br /> business </h1>
        </div> 
      </div>
