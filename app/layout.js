  ...
  return (
    <html lang="en">
      <body className={roboto.className}>
        <div className='absolute bottom-3 z-40 text-white flex  flex-col gap-4 pl-3  '>
        ...
        <div className='absolute items-right text-right top-3 z-40 text-white flex  flex-col gap-4 right-3  '>
          <Navbar />
        </div>
      </body>
    </html>
